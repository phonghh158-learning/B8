...
let {SignUpValidator,LoginValidator,UpdateValidator,validate} = require('../utils/validator')
...
router.get('/me', LoginValidator, validate, check_authentication, function (req, res, next) {
    CreateSuccessResponse(res, 200, req.user)
})
router.post('/change_password',UpdateValidator,validate, check_authentication,
...
router.post('/forgotpassword', UpdateValidator, validate, async function (req, res, next) {
    try {
...
router.post('/resetpassword/:token', UpdateValidator, validate, async function (req, res, next) {
    try {
